<div class="max-w-7xl mx-auto p-6 lg:px-8">
    <div class="p-4 bg-white shadow rounded-lg">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-6 mt-4">Edit Fuel Station</h1>
        <div class="relative">
            <?php
                $session = session();
                ...
                <?php endif;
            ?>
            <form action="<?= base_url('home/update-fuel-station/' . $station['id']); ?>" enctype="multipart/form-data" method="POST">
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        value="<?= isset($station['name']) ? htmlspecialchars($station['name']) : '' ?>"
                    >
                </div>
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        name="fuel_type" 
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?= isset($station['fuel_type']) ? htmlspecialchars($station['fuel_type']) : '' ?>"
                    >
                </div>
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        name="fuel_price" 
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?= isset($station['fuel_price']) ? htmlspecialchars($station['fuel_price']) : '' ?>"
                    >
                </div>
                <div class="mb-5">
                    ...
                    <?php if ($station['image']): ?>
                        <p>Current Image : <img src="<?= base_url('uploads/images/' . $station['image']); ?>" alt="Current Image" width="100"></p>
                    <?php endif; ?>
                </div>
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        name="status" 
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?= isset($station['status']) ? htmlspecialchars($station['status']) : '' ?>"
                    >
                </div>
                <div class="mb-5">
                    <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                    <textarea name="address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><?= isset($station['address']) ? htmlspecialchars($station['address']) : '' ?></textarea>
                </div>
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        name="near_by_place" 
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?= isset($station['near_by_place']) ? htmlspecialchars($station['near_by_place']) : '' ?>"
                    >
                </div>
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        name="latitude" 
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?= isset($station['latitude']) ? htmlspecialchars($station['latitude']) : '' ?>"
                    >
                </div>
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        name="longitude" 
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?= isset($station['longitude']) ? htmlspecialchars($station['longitude']) : '' ?>"
                    >
                </div>
